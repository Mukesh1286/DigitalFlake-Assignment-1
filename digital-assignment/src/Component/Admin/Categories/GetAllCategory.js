...
import { GetcategoryAction } from '../../../features/category/categorySlice';
...
const GetAllCategory = () => {
  ...
  const { categorys, isError, isSuccess, isLoading, message } = useSelector((state) => state?.category)
